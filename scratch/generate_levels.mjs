...
const filePath = path.resolve('src/levels/LevelData.js');
let content = fs.readFileSync(filePath, 'utf-8');

// 1. Update CHAPTERS array
const oldChapters = `export const CHAPTERS = [
  {
    id: 'world-1',
    name: '第一章：合數平原',
...
const newChapters = `export const CHAPTERS = [
  {
    id: 'world-1',
    name: '第一章：合數平原',
    subtitle: '掌握質數除法，挑戰合數泰坦',
...
content = content.replace(oldChapters, newChapters);

// 2. Link 2-4 nextLevelId to 3-1
content = content.replace(
  `    nextLevelId: null,\n    initialGold: 700,\n    initialLives: 10,\n    lanes: [\n      // 上路 (Lane 0)`,
  `    nextLevelId: '3-1',\n    initialGold: 700,\n    initialLives: 10,\n    lanes: [\n      // 上路 (Lane 0)`
);

// 3. Define Level Data for Chapter 3, 4, 5
...
// Insert additionalLevels right before the closing brace of LEVELS
content = content.replace(/\n\s*\}\s*;\s*$/, additionalLevels + '\n};\n');

fs.writeFileSync(filePath, content, 'utf-8');
console.log('Successfully updated LevelData.js with Chapters 3, 4, and 5!');
