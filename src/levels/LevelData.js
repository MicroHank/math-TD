...
export const LEVELS = {
  '1-1': {
    ...
    name: '1-1 偶數小徑（雙流迴旋谷）',
    subtitle: '偶數除法多段打擊入門',
    tip: '💡 滿版單畫面！雙路迴旋夾道佈置 18 處緊湊基座，沿線整齊建置 2 號砲截擊偶數前鋒！',
    nextLevelId: '1-2',
    initialGold: 600,
    initialLives: 10,
    worldWidth: 960,
  ...
  '1-2': {
    ...
    tip: '💡 經典蛇形 3 折迴廊！基座在平行直道間隙整齊列隊，2 號與 3 號激光交叉掩護！',
    nextLevelId: '1-3',
    initialGold: 700,
    initialLives: 10,
    worldWidth: 960,
  ...
  '1-3': {
    ...
    tip: '💡 三路合流三角洲！中央設置交叉火網，緊隨河岸兩側整齊佈建質數重砲！',
    nextLevelId: '1-4',
    initialGold: 850,
    initialLives: 10,
    worldWidth: 960,
  ...
  '1-4': {
    ...
    tip: '💡 合數泰坦殿堂！魔王自外環螺旋深入中央核心，在同心環道兩側整齊排布雙質數砲！',
    nextLevelId: '2-1',
    initialGold: 1000,
    initialLives: 10,
    worldWidth: 960,
  ...
  '2-1': {
    ...
    tip: '💡 絕對值中軸大道！正負兩道自兩翼湧入中央稜鏡走廊，在中央軸線建置 |x| 稜鏡！',
    nextLevelId: '2-2',
    initialGold: 1100,
    initialLives: 10,
    worldWidth: 960,
  ...
  '2-2': {
    ...
    subtitle: '正負交替與運算子變換',
    tip: '💡 階梯雙向梯流！負數怪自上下兩階折線匯流於中央大道，沿主軸佈署絕對值防線！',
    nextLevelId: '2-3',
    initialGold: 1200,
    initialLives: 10,
    worldWidth: 960,
  ...
  '2-3': {
    ...
    tip: '💡 雙重馬蹄型冰谷！設置 ×0 絕對零度塔進行全谷減速，再以質數重砲集火殲滅！',
    nextLevelId: '2-4',
    initialGold: 1300,
    initialLives: 10,
    worldWidth: 960,
  ...
  '2-4': {
    ...
    tip: '💡 負數造物主王座！正負交錯迴流匯聚於中央核心，基座圍繞雙螺旋迴圈對稱排列！',
    nextLevelId: '3-1',
    initialGold: 1450,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-1': {
    ...
    tip: '💡 正方同心環形回廊！在中心重力圈設置 √x 重力井，對進入內環的平方怪造成毀滅暴擊！',
    nextLevelId: '3-2',
    initialGold: 1400,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-2': {
    ...
    tip: '💡 階梯平台三重直角交會！基座分佈於各階梯拐點與中央主幹道，形成緊湊直角火力網！',
    nextLevelId: '3-3',
    initialGold: 1500,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-3': {
    ...
    tip: '💡 傅立葉正弦雙諧波！雙波跨越中央節點，終點匯流於同一核心，配置諧波共振塔享受共振加成！',
    nextLevelId: '3-4',
    initialGold: 1600,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-4': {
    ...
    tip: '💡 平方魔王中心十字聖殿！魔王自上下兩翼環繞穿越十字路口，集中火力升級方根守護中央核心！',
    nextLevelId: '4-1',
    initialGold: 1800,
    initialLives: 10,
    worldWidth: 960,
  ...
  '4-1': {
    ...
    subtitle: '質數巨獸群正面突襲戰',
    tip: '💡 質數要塞外環護城河！基座沿城牆內側整齊林立，建置運算子調整塔微調質數！',
    nextLevelId: '4-2',
    initialGold: 1800,
    initialLives: 10,
    worldWidth: 960,
  ...
  '4-2': {
    ...
    tip: '💡 雙子質數星軌！上下兩條等距雙星波道，於終點共聚中央防衛核心！',
    nextLevelId: '4-3',
    initialGold: 1950,
    initialLives: 10,
    worldWidth: 960,
  ...
  '4-3': {
    ...
    subtitle: '雙子質數怪夾縫突破',
    tip: '💡 同餘 mod 5 引力漩渦！雙路旋轉環抱中央同餘黑洞，餘數化合完美截擊！',
    nextLevelId: '4-4',
    initialGold: 2100,
    initialLives: 10,
    worldWidth: 960,
  ...
  '4-4': {
    ...
    tip: '💡 四方衛城四路合圍！魔王自四角傳送門突襲中央皇宮，緊靠四條對角防線整齊防守！',
    nextLevelId: '5-1',
    initialGold: 2300,
    initialLives: 10,
    worldWidth: 960,
  ...
  '5-1': {
    ...
    tip: '💡 莫比烏斯交織維度！雙環交錯穿越高維空間後匯流於同一核心，建置虛數引力稜鏡與費馬天琴！',
    nextLevelId: '5-2',
    initialGold: 2400,
    initialLives: 10,
    worldWidth: 960,
  ...
  '5-2': {
    ...
    tip: '💡 費馬切線向量折射道！切線斜率連環刀 d/dx 於各折角處傾瀉斜率重擊！',
    nextLevelId: '5-3',
    initialGold: 2600,
    initialLives: 10,
    worldWidth: 960,
  ...
  '5-3': {
    ...
    tip: '💡 蒙地卡羅概率網絡！三道分流交織機率並收束於守護核心，設置骰子投擲機體驗 300% 質數暴擊！',
    nextLevelId: '5-4',
    initialGold: 2800,
    initialLives: 10,
    worldWidth: 960,
  ...
  '5-4': {
    ...
    tip: '💡 終焉造物主雙星軌道！雙向星環拱衛終焉宇宙核心，調動全系列複合神塔迎戰造物主！',
    nextLevelId: '1-1',
    initialGold: 3200,
    initialLives: 10,
    worldWidth: 960,
