...
export const LEVELS = {
  ...
  '2-2': {
    ...
    subtitle: '正負交替與運算子變換',
    tip: '💡 階梯雙向梯流！負數怪沿折線狂飆，基座緊貼階梯橫直夾角整齊排布！',
    nextLevelId: '2-3',
    initialGold: 1200,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-2': {
    ...
    tip: '💡 階梯平台三重直角交會！基座分佈於各階梯拐點與中道，形成緊湊直角火力網！',
    nextLevelId: '3-3',
    initialGold: 1500,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-3': {
    ...
    tip: '💡 傅立葉正弦雙諧波！波峰與波谷兩端配置諧波共振塔與質數群，享受共振加成！',
    nextLevelId: '3-4',
    initialGold: 1600,
    initialLives: 10,
    worldWidth: 960,
  ...
  '3-4': {
    ...
    tip: '💡 平方魔王雙十字戰場！魔王兩度穿過中央十字路口，集中火力升級方根與七曜天琴！',
    nextLevelId: '4-1',
    initialGold: 1800,
    initialLives: 10,
    worldWidth: 960,
  ...
  '4-2': {
    ...
    tip: '💡 雙子質數星軌！上下兩條等距雙星波道，在中央與外側整齊夾道防禦！',
    nextLevelId: '4-3',
    initialGold: 1950,
    initialLives: 10,
    worldWidth: 960,
  ...
  '5-1': {
    ...
    tip: '💡 莫比烏斯交織維度！雙環交錯走廊，建置虛數引力稜鏡與費馬天琴！',
    nextLevelId: '5-2',
    initialGold: 2400,
    initialLives: 10,
    worldWidth: 960,
  ...
  '5-3': {
    ...
    tip: '💡 蒙地卡羅概率網絡！三道分流交織機率，設置骰子投擲機體驗 300% 質數暴擊！',
    nextLevelId: '5-4',
    initialGold: 2800,
    initialLives: 10,
    worldWidth: 960,
